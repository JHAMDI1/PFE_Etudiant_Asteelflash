...
namespace PFE_Etudiant_Asteelflash.Application.Authentication.Services
{
    public class AuthService : IAuthService
    {
        ...
        {
            var user = await _authRepository.GetUserByMatriculeAsync(loginRequestDto.Matricule);
        ...
        public async Task<string> Register(RegistrationRequestDto registrationRequestDto)
        {
            ...
            var newUser = new ApplicationUser
            {
                ...
                Fonction = registrationRequestDto.Fonction,
                PhoneNumber = registrationRequestDto.PhoneNumber,
                UsersZaps = registrationRequestDto.ZapIds?.Select(id => new UsersZaps { ZapId = id }).ToList() ?? new List<UsersZaps>(),
                Matricule = registrationRequestDto.Matricule,
                 ProfileImagePath = registrationRequestDto.ProfileImagePath
            };
            ...
            if(! await _authRepository.RoleExistsAsync(registrationRequestDto.Fonction.ToString()))
            {
                await _authRepository.CreateRoleAsync(registrationRequestDto.Fonction.ToString());
            }

            await _authRepository.AddUserToRoleAsync(newUser, (registrationRequestDto.Fonction).ToString());
        ...
        public async Task<ApplicationUser?> GetUserByMatriculeAsync(string matricule)
        {
            return await _authRepository.GetUserByMatriculeAsync(matricule);
        }
