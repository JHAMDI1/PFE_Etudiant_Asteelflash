...
namespace PFE_Etudiant_Asteelflash.Infrastucture.Migrations
{
    ...
    [Migration("20250905212333_AddFncTriPlanRelations")]
    partial class AddFncTriPlanRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.Fnc", b =>
                {
                    ...
                    b.Property<string>("Action_de_reparation")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<bool>("Approbation_conducteur")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("Enonce_de_la_reclamaion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("TraitementChoisi")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.PlanActionFncQrqc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DateCreationDoc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal?>("TauxClotureActions")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("TauxEfficacite")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal?>("TauxRespectDelais")
                        .HasColumnType("decimal(5,2)");

                    b.Property<string>("VersionDoc")
                        .HasMaxLength(10)
                    ...
                    b.ToTable("PlanActionFnc");
                });

            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.PlanActionFncQrqcLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("DateMesureEfficacite")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("PlanActionFncQrqcId")
                        .HasColumnType("int");

                    b.Property<string>("PointCritique")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Processus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RespMesureEfficacite")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Responsable")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("Retard")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlanActionFncQrqcId");

                    b.ToTable("PlanActionFncLigne");
                });
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.Qrqc", b =>
                {
                    ...
                    b.Property<DateTime?>("ClotureDecisionAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("ClotureDecisionById")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ClotureDecisionComment")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("ClotureToken")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("ClotureTokenExpiry")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateOuverture")
                        .HasColumnType("datetime2")
                        .HasColumnName("Date_Ouerture");
                    ...
                    b.HasIndex("ClotureDecisionById");
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.TriFncQrqc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DateTri")
                        .HasColumnType("datetime2");

                    b.Property<int>("FncId")
                        .HasColumnType("int");

                    b.Property<string>("NumeroAlerte")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ObjetTri")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PiloteId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PiloteName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("PourcentageDefaut")
                        .HasColumnType("decimal(5,2)");

                    b.Property<string>("ReferenceProduit")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("TotalNonConforme")
                        .HasColumnType("int");

                    b.Property<int>("TotalTrie")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.TriFncQrqcLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DefautsDetectes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MatriculeOperateur")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<int>("QuantiteNonConforme")
                        .HasColumnType("int");

                    b.Property<int>("QuantiteTriee")
                        .HasColumnType("int");

                    b.Property<int>("TriFncQrqcId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TriFncQrqcId");

                    b.ToTable("TriFncLigne");
                });
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.UsersZaps", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.PlanActionFncQrqc", b =>
                {
                    b.HasOne("PFE_Etudiant_Asteelflash.Domain.Entities.Fnc", "Fnc")
                        .WithOne("PlanActionFnc")
                        .HasForeignKey("PFE_Etudiant_Asteelflash.Domain.Entities.PlanActionFncQrqc", "FncId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.PlanActionFncQrqcLigne", b =>
                {
                    b.HasOne("PFE_Etudiant_Asteelflash.Domain.Entities.PlanActionFncQrqc", "PlanActionFncQrqc")
                        .WithMany("Lignes")
                        .HasForeignKey("PlanActionFncQrqcId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("PlanActionFncQrqc");
                });
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.Qrqc", b =>
                {
                    b.HasOne("PFE_Etudiant_Asteelflash.Domain.Entities.ApplicationUser", "ClotureDecisionBy")
                        .WithMany()
                        .HasForeignKey("ClotureDecisionById")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("ClotureDecisionBy");
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.Recherche_causes_racinesD4", b =>
                {
                    ...
                    b.HasOne("PFE_Etudiant_Asteelflash.Domain.Entities.Qrqc", "Qrqc")
                        .WithOne("Recherche_causes_racinesD4")
                        .HasForeignKey("PFE_Etudiant_Asteelflash.Domain.Entities.Recherche_causes_racinesD4", "QrqcId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.TriFncQrqc", b =>
                {
                    b.HasOne("PFE_Etudiant_Asteelflash.Domain.Entities.Fnc", "Fnc")
                        .WithOne("TriFnc")
                        .HasForeignKey("PFE_Etudiant_Asteelflash.Domain.Entities.TriFncQrqc", "FncId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.TriFncQrqcLigne", b =>
                {
                    b.HasOne("PFE_Etudiant_Asteelflash.Domain.Entities.TriFncQrqc", "TriFncQrqc")
                        .WithMany("Lignes")
                        .HasForeignKey("TriFncQrqcId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("TriFncQrqc");
                });
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.Qrqc", b =>
                {
                    ...
                    b.Navigation("Recherche_causes_racinesD4");
            ...
            modelBuilder.Entity("PFE_Etudiant_Asteelflash.Domain.Entities.TriActionImmediateGlobale", b =>
                {
                    b.Navigation("QuantitéTriéeParJour");
                });
